...
class PaymentTunaiTokopedia extends StatelessWidget {
  const PaymentTunaiTokopedia({super.key});
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    InstructionItem(
                        number: '1',
                        text:
                            'Minta bantuan penjaga warung/toko untuk isi saldo.'),
                    InstructionItem(
                        number: '2',
                    ...
                    InstructionItem(
                        number: '3',
                        text:
                            'Berikan nominal saldo yang ingin diisi ke penjaga warung/toko.'),
                    InstructionItem(
                        number: '4',
                        text:
                    ...
                    InstructionItem(
                        number: '5',
                        text:
                            'Penjaga warung/toko akan mengisi saldo ke akun e-wallet.'),
                    InstructionItem(
                        number: '6',
                        text:
